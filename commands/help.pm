...
sub main {
  ...
  $message .= "2. Disable any firewalls that are currently running.\n";
  $message .= "3. Make sure you are not connecting through a wireless connection or using a router.\n";
  $message .= "4. Refresh your IP address and restart the client.\n";
  $message .= "5. In your connection settings, make sure you are using \'Direct connection\'.\n";
  $message .= "6. Check your firewall settings to ensure it allows the DC client you're running through.\n";
  $message .= "7. Restart your your client and try to connect again and check to see if the problem has been fixed.\n";
